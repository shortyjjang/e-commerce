...
export default function Select({
  ...
  const [dropdownPosition, setDropdownPosition] = useState<"top-full" | "bottom-full">("top-full");
  ...
  return (
    ...
    >
      <div
        className="flex items-center relative justify-between px-4 py-2 bg-gray-100 rounded cursor-pointer"
      ...
      {isOpen && options.length > 0 && (
        <ul
          ref={listRef}
          className={twMerge(
            "absolute min-w-full whitespace-nowrap w-fit max-h-[300px] overflow-y-auto border border-gray-300 rounded bg-white shadow-lg",
            dropdownPosition
          )}
        >
